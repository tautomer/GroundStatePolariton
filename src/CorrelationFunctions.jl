...
"""
function getCentroid(a::Vector{Float64}) 
    return a[1]
end
...
"""
function getCentroid(a::Matrix{Float64})
    @views c = mean(a[:, 1])
    return c
end
...
"""
function fluxSide(corrFS::T, v0::T, q::T) where T<:Float64
...
function normalize!(fs::AbstractVector{T}, fs0::T) where T<:Float64
